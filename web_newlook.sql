...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 20, 2024 lúc 08:54 AM
...
(6, 'ai mà biết đâu', '<p>admfnsklgnvalkdghalke</p>\r\n', '<p>sd.,ngskeldjfvisdfhgiosehrgiosdg</p>\r\n', 6, 1, '1705904710_');
...
INSERT INTO `tbl_dangky` (`id_dangky`, `tenkhachhang`, `email`, `diachi`, `matkhau`, `dienthoai`, `role`) VALUES
(15, 'Nguyễn Quang Nhật', 'nqnhatdz008@gmail.com', 'D2 Cư Xá Đồng Tiến, phường 14, quận 10', '25f9e794323b453885f5181f1b624d0b', '0948577175', 'user'),
(16, 'Nguyễn Quang Nhật', 'quangnhatdz008@gmail.com', 'D2 Cư Xá Đồng Tiến, phường 14, quận 10', 'e10adc3949ba59abbe56e057f20f883e', '0948577175', 'user'),
(18, 'Minh Nhật', 'minhnhat123@gmail.com', '123 xô viết nghệ tĩnh', 'e10adc3949ba59abbe56e057f20f883e', '0123456789', 'user');
...
--
ALTER TABLE `tbl_cart_details`
  MODIFY `id_cart_details` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
