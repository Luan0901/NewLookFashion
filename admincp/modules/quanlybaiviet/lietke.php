...
<table style="width:100%" border="1" style="border-collapse: collapse;">
  ...
  <tr>
    ...
    <td style="text-align: center;">
   		<a href="modules/quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['id'] ?>"><i class="fa-solid fa-trash"></i></a> | <a href="?action=quanlybaiviet&query=sua&idbaiviet=<?php echo $row['id'] ?>"><i class="fa-solid fa-screwdriver-wrench"></i></a> 
   	</td>
